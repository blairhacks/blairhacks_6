	...
	return (
		<>
			<Head>
				...
				<meta
					name="description"
					content="BlairHacks_6 is a hackathon hosted by high school students in Silver Spring, MD. Join us for a weekend, where we'll discover the joy of coding, build and showcase cool projects, and make new friends!"
				/>
			</Head>
			...
			<main className="px-8 py-10 container max-w-6xl flex flex-col gap-4">
				<section className="flex flex-col md:flex-row gap-6 md:gap-20">
					<div>
						<h1 className="text-4xl font-bold">BlairHacks_6</h1>
						<p className="pl-[1px] text-lg font-thin">
							March 25-26, 2023{" "}
							<span className="text-theme-secondary font-medium underline underline-offset-1">
								@ Virtual + Montgomery College Rockville Campus
							</span>
						</p>
					</div>
				</section>
				...
				<section className="flex flex-col-reverse md:flex-row gap-16 mt-2">
					<div className="flex-1 flex flex-col gap-12">
						...
						<div className="text-lg font-thin">
							<p>
								BlairHacks is an annual hackathon{" "}
								<span className="text-theme-onBackground/50">
									(collaborative coding event)
								</span>{" "}
								hosted by high school students in Silver Spring, MD. This year,
								BlairHacks_6 is happening in March, and we&apos;re going all in
								with hands-on activities, huge prizes, and tons of fun. Join us
								for a weekend, where we&apos;ll discover the joy of coding,
								build and showcase cool projects, and make new friends!
							</p>
						</div>
						...
						<div>
							...
							<p className="font-thin mt-2">
								BlairHacks_6 will take place in 2 days — virtually on Saturday
								and in-person on Sunday.
							</p>
						...
						<div>
							<h2 className="text-2xl font-medium">Competition</h2>

							<p className="font-thin mt-2">
								You can form teams of up to 4 people or work by yourself. Each
								team will create a project — a website, game, app, or anything
								else — that addresses the prompt that will be revealed at the
								beginning of the event. On day 2, you&apos;ll have the
								opportunity to showcase your project at the project expo, and
								win awesome, custom prizes and swag for it!
							</p>
							...
							<div className="px-4 py-2 border-[3px] border-fuchsia-200/75 rounded-xl mt-8">
								...
								<div className="flex flex-wrap items-center gap-6 mt-2">
									<img
										src="/assets/prizes/gamingheadphones.png"
										className="h-12"
									/>
									<img
										src="/assets/prizes/bluetoothspeaker.png"
										className="h-12"
									/>
									<img src="/assets/prizes/echodot.png" className="h-12" />
									<img src="/assets/prizes/airtags.png" className="h-12" />
									<img
										src="/assets/prizes/wirelessearbuds.png"
										className="h-12"
									/>
						...
						<div>
							<h2 className="text-2xl font-medium">Workshops + activities</h2>

							<p className="font-thin mt-2">
								We&apos;ll run plenty of hardware and software workshops as well
								as fun activities throughout the 2-day event!
							</p>
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
								<div className="px-4 py-4 border-[3px] border-blue-200/75 rounded-xl">
									...
									<p className="text-sm font-thin mt-1">
										<span className="italic">Day 1</span> — Learn new languages
										and tools that you can use to develop your project!
									</p>
									...
									<p className="text-sm font-thin mt-1">and more!</p>
								</div>
								...
								<div className="relative row-span-2 px-4 py-4 border-[3px] border-blue-200/75 rounded-xl">
									...
									<p className="text-sm font-thin mt-1">
										<span className="italic">Day 2</span> — Make code come to
										life with Raspberry Pi Picos
									</p>

									<ul className="pl-2 list-disc list-inside text-sm mt-2">
										<li>
											Make gadgets and control objects in real life with Python
									...
									<img
										src="/assets/hardware_graphic.png"
										className="absolute w-1/3 bottom-0 right-4"
									/>
								</div>

								<div className="px-4 py-4 border-[3px] border-blue-200/75 rounded-xl">
									<h3 className="text-sm font-bold font-monoone -mt-7">
										<span className="px-1 bg-theme-background">
											Tech escape room
										</span>
									</h3>

									<p className="text-sm font-thin mt-1">
										<span className="italic">Day 2</span> — Team up and use your
										combined tech knowledge and skills to escape!
									</p>
								</div>
							</div>
						</div>
						...
						<div className="pt-24 sticky top-0">
							<div className="px-4 py-2.5 flex-1 border-2 border-theme-secondary/50 rounded-lg">
								...
								<p className="text-sm text-theme-secondary font-thin leading-4 mt-0.5">
									Registration is now open! Detailed info and address will be
									sent to registrants a week before the event.
								</p>
								<p className="text-sm text-theme-secondary font-thin leading-4 mt-3">
									<span className="font-bold">Note:</span> If you&apos;ve
									previously registered for our old dates, you will have to
									re-register.
								</p>
							</div>
							...
							<a
								//href="https://form.typeform.com/to/bxlqbYuD"
								//target="_blank"
								//rel="noreferrer noopener"
							>
								<button className="w-full px-4 py-3 bg-theme-onSurface bg-opacity-75 text-theme-surface text-sm uppercase font-semibold rounded-lg mt-2">
									Registration is closed
								</button>
							</a>
              <p className="pt-2 pl-1 text-sm text-neutral-300">
            ...
            /> */}
							...
							<ul className="px-4 flex flex-col gap-4 font-thin mt-8">
								<li className="flex justify-start items-center min-h-[2rem] gap-5 leading-5">
									...
									<p className="">All high school students welcome</p>
								</li>
								...
								<li className="flex justify-start items-center min-h-[2rem] gap-5 leading-5">
									...
									<p className="">Everything is free</p>
								</li>
								...
								<li className="flex justify-start items-center min-h-[2rem] gap-5 leading-5">
									...
									<p className="">Beginners welcome</p>
								</li>
							</ul>
						</div>
					</div>
					...
					<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mt-4">
						<div className="px-5 py-4 bg-theme-surface text-theme-onSurface rounded-xl">
							...
							<p className="text-theme-onSurface/75 text-sm font-thin mt-1.5">
								A hackathon is a coding marathon event where people come
								together to create apps, games, and solutions to address a
								common real-world problem. The problem can be big or small,
								serious or comedic!
							</p>
						</div>
						...
						<div className="px-5 py-4 bg-theme-surface text-theme-onSurface rounded-xl">
							...
							<p className="text-theme-onSurface/75 text-sm font-thin mt-1.5">
								Day 1 will happen virtually though Discord and Zoom on March
								25th. Day 2 will be in-person at Montgomery College Rockville
								Campus on March 26th.
							</p>
						</div>
						...
						<div className="px-5 py-4 bg-theme-surface text-theme-onSurface rounded-xl">
							...
							<p className="text-theme-onSurface/75 text-sm font-thin mt-1.5">
								Yes! On day 2, we&apos;ll provide meals, snacks, and beverages
								on-site, as well as swag, prizes, and fun activities.
							</p>
						</div>
						...
						<div className="px-5 py-4 bg-theme-surface text-theme-onSurface rounded-xl">
							...
							<p className="text-theme-onSurface/75 text-sm font-thin mt-1.5">
								...
								, and our socials are linked below too.
							</p>
						</div>
					</div>
				</section>
				...
				<section className="mt-8">
					...
					<div className="flex justify-center sm:justify-start items-center flex-wrap gap-6 sm:gap-12 mt-6">
						...
						<a
							href="https://www.postman.com/student-program/student-expert/?utm_campaign=UOE&utm_medium=referral&utm_source=external&utm_term=sponsorship&utm_content=Blair-Hacks-25032023"
							target="_blank"
							rel="noreferrer noopener"
						>
							<Image
